                    ...
                    <View className="flex-1 py-10 px-8 items-start justify-between gap-y-10">
                        ...
                        <View className="w-full gap-y-10">
                            <View className="gap-y-2">
                                <Text className="text-center text-3xl font-raleway-600 text-zinc-950">Sign in</Text>
                                <Text className="text-center text-zinc-400 font-raleway-400 text-lg">Enter your email and password to sign in.</Text>
                            </View>
                            <SignInForm />
                        </View>
                        <View className="w-full items-center justify-center">
                            <Link href="/sign-up" asChild>
                                <Pressable className="h-10 px-4 rounded-lg items-center justify-center active:bg-zinc-100">
                                    <Text className="font-raleway-500 text-zinc-950">Don't have an account?</Text>
                                </Pressable>
                            </Link>
                        </View>
                    </View>
